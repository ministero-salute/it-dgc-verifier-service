...
public class SignerInformationController {
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(
                    ...
                    examples = {
                        @ExampleObject(
                            value = "MIIBGzCBwqADAgECAgRggUObMAoGCCqGSM49BAMCMBYxFDASBgNVBAMMC2VkZ2Nf" +
    ...
    public ResponseEntity<String> getSignerCertificateUpdate(
        @RequestHeader(
            value = X_RESUME_TOKEN_HEADER,
            required = false
        ) Long resumeToken
    ) {
        HttpHeaders responseHeaders = new HttpHeaders();
        SignerInformationEntity signerInformation = signerInformationService.getCertificate(
            resumeToken
        );
        ...
        responseHeaders.set(
            ...
            signerInformation.getId().toString()
        );
