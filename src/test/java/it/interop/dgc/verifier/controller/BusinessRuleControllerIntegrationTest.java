...
class BusinessRuleControllerIntegrationTest {
    ...
    void getEmptyRulesList() throws Exception {
        mockMvc
            .perform(get("/v1/dgc/rules").header(API_VERSION_HEADER, "1.0"))
    ...
    void getRulesList() throws Exception {
        String expectedJson =
            "[{\"identifier\":\"VR-DE-1\",\"version\":\"1.0.0\",\"country\":\"DE\",\"hash\":" +
        ...
        mongoTemplate.save(
            BusinessRulesTestHelper.getBusinessRule(
                BusinessRulesTestHelper.BR_HASH_1,
                BusinessRulesTestHelper.BR_IDENTIFIER_1,
                BusinessRulesTestHelper.BR_COUNTRY_1,
                BusinessRulesTestHelper.BR_VERSION_1,
                BusinessRulesTestHelper.BR_DATA_1
            ),
            BusinessRulesTestHelper.BR_TEST_COLLECTION
        );
        ...
        mongoTemplate.save(
            BusinessRulesTestHelper.getBusinessRule(
                BusinessRulesTestHelper.BR_HASH_2,
                BusinessRulesTestHelper.BR_IDENTIFIER_2,
                BusinessRulesTestHelper.BR_COUNTRY_2,
                BusinessRulesTestHelper.BR_VERSION_2,
                BusinessRulesTestHelper.BR_DATA_2
            ),
            BusinessRulesTestHelper.BR_TEST_COLLECTION
        );
        ...
        mongoTemplate.save(
            BusinessRulesTestHelper.getBusinessRule(
                BusinessRulesTestHelper.BR_HASH_3,
                BusinessRulesTestHelper.BR_IDENTIFIER_3,
                BusinessRulesTestHelper.BR_COUNTRY_3,
                BusinessRulesTestHelper.BR_VERSION_3,
                BusinessRulesTestHelper.BR_DATA_3
            ),
            BusinessRulesTestHelper.BR_TEST_COLLECTION
        );
    ...
    void getRulesListSameRuleWithDiffrentVersions() throws Exception {
        String expectedJson =
            "[{\"identifier\":\"VR-DE-1\",\"version\":\"1.0.0\",\"country\":\"DE\"," +
        ...
        mongoTemplate.save(
            BusinessRulesTestHelper.getBusinessRule(
                BusinessRulesTestHelper.BR_HASH_4,
                BusinessRulesTestHelper.BR_IDENTIFIER_4,
                BusinessRulesTestHelper.BR_COUNTRY_4,
                BusinessRulesTestHelper.BR_VERSION_4,
                BusinessRulesTestHelper.BR_DATA_4
            ),
            BusinessRulesTestHelper.BR_TEST_COLLECTION
        );
    ...
    void getEmptyRulesListForCountry() throws Exception {
        mockMvc
            .perform(
                get("/v1/dgc/rules/" + BusinessRulesTestHelper.BR_COUNTRY_1)
    ...
    void getRulesListForCountryWrongCountryFormat() throws Exception {
        String expectedJson =
            "{\"code\":\"0x004\",\"problem\":\"Possible reasons: The Country Code has a wrong format." +
            " Should be 2 char format.\",\"sendValue\":\"EUR\",\"details\":\"\"}";

        mockMvc
            .perform(get("/v1/dgc/rules/EUR").header(API_VERSION_HEADER, "1.0"))
        ...
        mockMvc
            .perform(get("/v1/dgc/rules/E").header(API_VERSION_HEADER, "1.0"))
            .andExpect(status().isBadRequest())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
            .andExpect(content().json(expectedJson));
        ...
        mockMvc
            .perform(get("/v1/dgc/rules/22").header(API_VERSION_HEADER, "1.0"))
            .andExpect(status().isBadRequest())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
            .andExpect(content().json(expectedJson));
    }
    ...
    void getRuleByCountryAndHashWrongCountryFormat() throws Exception {
        ...
        mockMvc
            .perform(
                get("/v1/dgc/rules/EUR/" + BusinessRulesTestHelper.BR_HASH_1)
                    .header(API_VERSION_HEADER, "1.0")
            )
            .andExpect(status().isBadRequest())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        mockMvc
            .perform(
                get("/v1/dgc/rules/E/" + BusinessRulesTestHelper.BR_HASH_1)
                    .header(API_VERSION_HEADER, "1.0")
            )
            .andExpect(status().isBadRequest())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        mockMvc
            .perform(
                get("/v1/dgc/rules/23/" + BusinessRulesTestHelper.BR_HASH_1)
                    .header(API_VERSION_HEADER, "1.0")
            )
            .andExpect(status().isBadRequest())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void getRuleByCountryAndHashWrongCountryHashCombination() throws Exception {
        String expectedJson =
            "{\"code\":\"0x006\",\"problem\":\"Possible reasons: The provided hash or country may " +
