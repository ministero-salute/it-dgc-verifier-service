...
public class SignerInformationTestHelper {
    ...
    public static final String TEST_COLLECTION = "signer_information";

    public static final Long TEST_CERT_1_RESUME_TOKEN = 1L;
    ...
    public static final Long TEST_CERT_2_RESUME_TOKEN = 2L;
    ...
    public static final Long TEST_CERT_3_RESUME_TOKEN = 3L;
    ...
    public static SignerInformationEntity getCert(String kid) {
        SignerInformationEntity entity = null;

        switch (kid) {
            case TEST_CERT_1_KID:
                entity =
                    new SignerInformationEntity(
                        TEST_CERT_1_RESUME_TOKEN,
                        TEST_CERT_1_KID,
                        TEST_CERT_1_STR,
                        CertificateType.DSC,
                        false
